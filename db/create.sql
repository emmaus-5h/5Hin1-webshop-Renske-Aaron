...
insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id, frame_id) values ('Poster Italiaanse Kerk', 'Een poster van een Italiaanse Kerk.', '445924201-X', '  16,5 x 23,4', '  Textiel', 6, 3, 3, 3, 1);
 ...
 insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id, frame_id) values ('Poster Stad', 'Een prachtige poster van een gebouw in de stad Dusseldorf in de nacht.', '693155505-7','  11,7 x 16,5', '  Glanzend Papier', 5.50, 3, 2, 2 , 2);

...
insert into products (name, description, code, grootte, materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster Molen', 'Een zeer mooie poster van een molen. ', '816905633-0',' 8,3 x 11,7', '  Mat Photo Papier', 5, 3, 1, 1);
...
insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster Italiaanse Kerk', 'Een poster van een Italiaanse Kerk.', '445924201-X', '  16,5 x 23,4', '  Textiel', 6, 3, 1, 3);
...
insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster Markthal Rotterdam', 'Een poster van een van de bekendste plekken van Rotterdam, de markthal!', '492662523-7','  16,5 x 23,4', '  Textiel', 6.50, 3, 2, 2);

insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster Italie', 'Een poster van het gezelligste stadje van Italie, Lido di Spina.', '492662523-7','  11,7 x 16,5', '  Glanzend Papier', 5.25, 2, 2, 3);
...
insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster Graffiti', 'Een poster van grafitti op een muur in Dusseldorf.', '492662523-7','  11,7 x 16,5', '  Glanzend Papier', 5.25, 2, 3, 2);

insert into products (name, description, code, grootte,  materiaal, price, soort_id, doelgroep_id, levertijd_id) values ('Poster De Verwoeste Stad', 'Een poster van een belangrijk beeld van Rotterdam, zadkine.', '492662523-7','  11,7 x 16,5', '  Textiel',5.75,2,1, 2);

...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.grootte AS grootte, products.materiaal AS materiaal, products.soort_id, products.doelgroep_id, levertijd.Levertijd FROM products JOIN levertijd ON products.levertijd_id = levertijd.id ORDER BY products.name')
